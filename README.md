# Домашнее задание к занятию "7.2. Облачные провайдеры и синтаксис Terraform." dev-17_terraform-syntax-yakovlev_vs
terraform-syntax
...
#### Невозможно сделать из-за проблем с работой aws на территории России
...
- Платежный аккаунт создан, подключен и он находится в статусе ACTIVE
...
token: AQA-------VAATuwVOS-------nbH10------
cloud-id: b1g4m8qmhdgh8k9b16jr
folder-id: b1g72hofn0r6eom3l3oo
...
Terraform will perform the following actions:
  ...
  # yandex_compute_instance.test01 will be created
...
Changes to Outputs:
  + external_ip_address_test01_yandex_cloud = (known after apply)
  + internal_ip_address_test01_yandex_cloud = (known after apply)
